...
public interface ChatPlatform {
     ...
     * @return a {@link CompletionStage} containing the {@link ChannelIO}
     */
    ...
    default @NonNull CompletionStage<? extends ChannelIO> getChannelIO(@NonNull String nick, @NonNull String channelName) {
