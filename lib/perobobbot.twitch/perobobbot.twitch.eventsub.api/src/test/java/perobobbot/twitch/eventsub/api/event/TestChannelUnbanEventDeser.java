...
public class TestChannelUnbanEventDeser extends AbstractEventDeserTest {

    public static Stream<String> samples() {
        return readObjects("channel_unban_event");
    }

    @ParameterizedTest
    @MethodSource("samples")
    public void testDeserialization(@NonNull String data) throws JsonProcessingException {
        final var event = objectMapper.readValue(data,ChannelUnbanEvent.class);
