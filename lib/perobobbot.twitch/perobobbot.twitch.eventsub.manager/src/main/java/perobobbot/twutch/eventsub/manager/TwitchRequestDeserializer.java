...
import perobobbot.twitch.eventsub.api.EvenSubRequest;
...
public class TwitchRequestDeserializer {
    ...
    public static @NonNull Optional<EvenSubRequest> deserialize(@NonNull ObjectMapper objectMapper, @NonNull String type, @NonNull byte[] content) {
    ...
    private Optional<EvenSubRequest> deserialize() {
