...
@Component
public class BotExtensionEntityPermissions extends DataEntityPermission {

    private final BotService botService;

    public BotExtensionEntityPermissions(@NonNull @UnsecuredService BotService botService, @NonNull @UnsecuredService UserService userService) {
        super("BotExtensionEntity");
