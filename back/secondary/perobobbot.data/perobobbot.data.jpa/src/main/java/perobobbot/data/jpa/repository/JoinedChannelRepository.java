...
public interface JoinedChannelRepository extends JpaRepository<JoinedChannelEntity, Long> {
    ...
    @NonNull List<JoinedChannelEntity> findAllByPlatformBot_Platform(@NonNull Platform platform);

    @NonNull Optional<JoinedChannelEntity> findByPlatformBot_UuidAndChannelId(@NonNull UUID platformBotId, @NonNull String channelId);
