...
@PluginServices(
        {
                @PluginService(type = MessageDispatcher.class, apiVersion = MessageDispatcher.VERSION,sensitive = false),
                @PluginService(type = ChatController.class, apiVersion = ChatController.VERSION,sensitive = false)
        }
)
