...
import static perobobbot.bot.common.irc.TagParserTest.TagParsingParameter.create;
...
public class TagParserTest {
    ...
    public static Stream<TagParsingParameter> validTags() {
        return Stream.of(
                create("+perococco.com/server-time=123\\:445",true,"perococco.com","server-time","123;445"),
                create("color=#1E90FF",false,null,"color","#1E90FF"),
                create("site.com/tag-as=two\\svalues\\:=result°",false,"site.com","tag-as","two values;=result°")
                );
    }
